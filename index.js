...
function showMovieModal(id){
  ...
  axios.get(INDEX_URL + id).then(response =>{
    ...
    modalImage = `<img src="${POSTER_URL + data.image}" alt="movie-poster" class="img-fuid">`
  })
}
...
dataPanel.addEventListener('click', function onPanleClick(event){
...
searchForm.addEventListener('submit', function onSearchSubmitted(event){
  ...
  if(filteredMovies.length === 0){
    return alert('Cannot find movie keyword: ' + keyword)
  }
